package org.axgl.util {
	...
	public class AxPauseState extends AxState {
		override public function create():void {
			...
			var tint:AxSprite = new AxSprite(0, 0).create(Ax.viewWidth, Ax.viewHeight, 0x88000000);
			var text:AxText = new AxText(0, Ax.height - 55, null, "@[255,255,255]P@[190,190,190]AUSED", Ax.width, "right");
			var focus:AxText = new AxText(0, Ax.height - 17, null, "CLICK TO FOCUS", Ax.width - 48, "right");
			// Set properties
